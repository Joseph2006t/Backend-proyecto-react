// este archivo se conectara al servidor postgreSQL
...
const dbConfig = {
    ...
    idleTimeoutMillis: 30000, // tiempo limite de espera
    ssl: {
...
// permite que varias personas puedan estar conectadas a la par
// pero genera esfuerzo en la base de datos
